...
public class Panel_incrementalCRL_enc extends ApplicationWindow {

	private Table table_261_i_enc;
	private Text text_basicPub_i_enc;
	private Combo combo_CRLType_i_enc;
	private Button btn_add_261_i_enc, btn_delete_262_i_enc, btn_addDN_i_enc;
	 ...
	 */
	public Panel_incrementalCRL_enc() {
		super(null);
	...
	public Extension packageTempInfo() {
		...
		TableItem[] items_26_i = table_261_i_enc.getItems();
	...
	// 增量CRL视图
	protected void panel_incrementalCRL_enc(final Composite composite_26_i) {
		...
		btn_addDN_i_enc.setLayoutData(gd_btn_addDN);
		...
		text_basicPub_i_enc.setLayoutData(gd_text_basicPub);
		...
		btn_add_261_i_enc.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				it.setText(new String[] { combo_CRLType_i_enc.getText(), s, text_basicPub_i_enc.getText().trim(), });
			}
		});
		new Label(group_261, SWT.NONE);
		new Label(group_261, SWT.NONE);
		...
		table_261_i_enc.setLayoutData(gd_table_261);
		...
		btn_delete_262_i_enc.setLayoutData(gd_btn_delete_262);
	...
	protected Control createContents(Composite parent) {
		...
		this.panel_incrementalCRL_enc(container);
	...
	public static void main(String args[]) {
		try {
			Panel_incrementalCRL_enc window = new Panel_incrementalCRL_enc();
