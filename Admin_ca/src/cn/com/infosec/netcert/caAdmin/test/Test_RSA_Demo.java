...
public class Test_RSA_Demo {
	...
	private static void testFree() {
		...
		// 列 Provider
		String[] pro_1 = UsbKeyCSPImpl.listProvider();
		for(String s : pro_1){
			System.out.println(s);
		}
		// 列 容器 信息
		UsbKeyCSPImpl csp_1 = new UsbKeyCSPImpl("XASJ Cryptographic Service Provider 31001");
		CspCertInfo[] cerList_1 = csp_1.listCert(IHSM.SIGN);
		
		for(CspCertInfo cc : cerList_1) {
			System.out.println(cc.provider);
			System.out.println("[容器: "+cc.container+"], [SN: "+cc.sn+"], [主题: "+cc.subject+"], [NB: "+cc.notBefore+"]");
		}
	...
	public static void testRSA() throws Exception{
		...
		for(CspCertInfo cc : cerList){
			...
			if ("00DDE4BFF3EC".equalsIgnoreCase(cc.sn)) {
				System.out.println(cc.subject);
				
				String name = cc.subject;
				System.out.println(name);
				String gbk_name = new String(name.getBytes("ISO-8859-1"),"gbk");
				System.out.println(gbk_name);
				
				byte[] bs_1 = new byte[]{67,78,61,-42,-48,-50,-60};
				System.out.println(new String(bs_1,"gbk"));
				
				byte[] bs_2 = new byte[]{-42,-48,-50,-60};
				System.out.println(new String(bs_2,"gbk"));
				
				byte[] bs_3 = cc.subject.getBytes("ISO-8859-1");
				for (byte b : bs_3) {
					System.out.print(b);
					System.out.print(",");
				}
				String name_2 = new String(bs_3,"utf-8");
				...
				byte[] bs_6 = "CN=test_业务管理员".getBytes("gbk");
				for (byte b : bs_6) {
					System.out.print(b);
					System.out.print(",");
				}
			...
			//System.out.println(cc.provider);
			if ("00DDE4BFF3EC".equals(cc.sn) || "00DDE4BFF3E5".equals(cc.sn)){
				System.out.println("[容器: "+cc.container+"], [SN: "+cc.sn+"], [主题: "+new String(cc.subject.getBytes("iso-8859-1"))+"], [NB: "+cc.notBefore+"]");
			}
...
/*
		...
		try {
			...
			userCSP.exportCertBase64(IHSM.SIGN, "6EAB26CD-91B9-49B7-A16B-6B4E6FBAC36D");
		} catch (Exception e){
			e.printStackTrace();
		} 
		*/
